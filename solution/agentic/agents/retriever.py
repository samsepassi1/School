"""Retrieval agent — semantic search over the Knowledge table."""
...
from agentic.retrieval import keyword_retrieve, retrieve
...
def retriever_node(state: AgentState) -> dict[str, Any]:
    ...
    logger.info("retriever ticket=%s docs=%d best=%.2f",
                state.get("ticket_id"), len(docs), best)
